...
<div style="display: flex;align-items: center;justify-content: space-between;background-color: black;">
...
<div class="header" style="padding-top: 40px;">Configuration commande</div>
...
<button class="advanced-options" onclick="redirectionoptionsavances();" style="height: 40px;">Options avancées</button>
...
<button id="Valider" type="submit" onclick="verifiertoucheduplique();afficherconfiguration();soumissionredirection(event);">Valider</button>
</form>
<script>
        ...
        function afficherconfiguration() {
            ...
            if(keytir === 'a'){
            	console.log(`bind a "+attack"`);
            	valeur5.innerHTML=`bind a "+attack"`;
            }else if(keytir === 'b'){
                console.log(`bind b "+attack"`);
                valeur5.innerHTML=`bind b "+attack"`;
            }else if(keytir === 'c'){
                console.log(`bind c "+attack"`);
                valeur5.innerHTML=`bind c "+attack"`;
            }else if(keytir === 'd'){
                console.log(`bind d "+attack"`);
                valeur5.innerHTML=`bind d "+attack"`;
            }else if(keytir === 'x'){
                console.log(`bind  "+attack"`);
                valeur5.innerHTML=`bind x "+attack"`;
            }
        ...
        function soumissionredirection(event) {
            window.location.href="configurationcommandercpd.php"
        }
...
function redirectionoptionsavances() {
