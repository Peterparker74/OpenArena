...
<body style="height: 100%;width: 100%;background-image: url('https://png.pngtree.com/background/20210715/original/pngtree-yellow-gradient-simplified-background-picture-image_1277937.jpg');margin: 0;padding: 0;">
    ...
    <div style="display: flex;justify-content: center;margin-bottom: 50px;position: absolute;bottom: 100px;width: 100%;">
            <a href="../creerorganisateur/index.php"><button type="submit" style="background-color: green;border: none;color: white;border-radius: 3px;margin-right: 25px;font-size: 16px;padding: 2px 5px 2 px 5px;">Créer un<br> organisateur</button></a>

    </div>

    <div style="display: flex;justify-content: center;margin-bottom: 50px;position: absolute;bottom: 200px;width: 100%;">
            <a href="../listeinscriptions/index.php"><button type="submit" style="background-color: green;border: none;color: white;border-radius: 3px;margin-right: 25px;font-size: 16px;padding: 2px 5px 2 px 5px;">Voir les<br> inscriptions</button></a>
