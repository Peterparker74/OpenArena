...
<body style="height: 100%;width: 100%;background-image: url('https://png.pngtree.com/background/20210715/original/pngtree-yellow-gradient-simplified-background-picture-image_1277937.jpg');margin: 0;padding: 0;">
    ...
    <div style="box-shadow: -100px -100px 100px 100px lightgray;border-top-left-radius: 8px;border-bottom-left-radius: 8px;" id="wrapper">
            ...
            <div id="souswrapper">
                    ...
                    <a style="display: flex;align-items: center;justify-content: flex-start;border-top: 2px solid lightgray;padding-top: 15px;" href="/openarena/deconnexion.php">
    ...
    <form style="" method="POST" action="index_traitement.php">
        ...
        <input type="text" required name="nomorganisateur" placeholder="Entrez le nom de l'administrateur" style="height: 33px;border: 1.5px solid lightgray;border-radius: 5px;font-size: 20px;text-align: center;margin-top: 50px;width: 60%;display: block;margin-bottom: 50px;margin-left: auto;margin-right: auto;">

        <input type="text" required name="prenomorganisateur" placeholder="Entrez le prénom de l'administrateur" style="height: 33px;border: 1.5px solid lightgray;border-radius: 5px;font-size: 20px;text-align: center;margin-top: 50px;width: 60%;display: block;margin-bottom: 50px;margin-left: auto;margin-right: auto;">
        ...
        <div style="display: flex;justify-content: flex-start;margin-bottom: 50px;width: 30%;position: relative;margin-left: auto;margin-right: auto;">
            <button type="submit" style="background-color: green;border: none;color: white;border-radius: 3px;height: 38px;margin-right: 25px;font-size: 20px;width: 100%;">Valider</button>
