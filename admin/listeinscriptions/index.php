...
<body style="height: 100%;width: 100%;background-image: url('https://png.pngtree.com/background/20210715/original/pngtree-yellow-gradient-simplified-background-picture-image_1277937.jpg');margin: 0;padding: 0;">
    ...
    <div class="unevenement" style="height: 120px;width: 100%;border-radius: 5px;border: 1.5px solid lightgray;display: flex;justify-content: space-between;align-items: center;margin-bottom: 35px;">

        <img src="../../photodeprofils/<?=$unjoueur->photo_de_profil?>" style="width: 90px;height: 90px;margin-left: 10px;border-radius: 50%;">

        <div class="infos" style="width: calc(100% - 120px);height: 100%;display: flex;flex-direction: column;justify-content: space-evenly;">
            <div style="font-size: 25px;color: blue;"><?=$unjoueur->nom_utilisateur?></div>
            <div style="font-size: 16px;color: gray;">Adresse mail: <?=$unjoueur->adresse_email?></div>
            <div style="font-size: 16px;color: gray;">Mot de passe: <?=$unjoueur->mot_de_passe?></div>

            <div style="font-size: 14px;padding-left: 50%;color: green;font-weight: bold;font-style: italic;">Inscrit le <?=$unjoueur->date_inscription?></div>
