...
<body style="height: 100%;width: 100%;background-image: url('https://png.pngtree.com/background/20210715/original/pngtree-yellow-gradient-simplified-background-picture-image_1277937.jpg');margin: 0;padding: 0;">
    ...
    <div style="text-align: center;padding: 10px 50px 10px 50px;font-size: 22px;color: gray;">
        Bienvenue sur OpenArena !<br>

        Explorez la collection de maps soigneusement sélectionnées pour une expérience de jeu exceptionnelle. Que vous soyez un vétéran chevronné ou un novice enthousiaste, découvrez des environnements captivants et des défis uniques pour enrichir votre aventure dans le monde d'OpenArena. Préparez-vous à plonger dans l'action et à vivre des batailles épiques sur nos maps variées. Que le meilleur gagne !
    </div>
    ...
    <div style="box-shadow: -100px -100px 100px 100px lightgray;display:none;" id="wrapper">
            ...
            <div id="souswrapper">
                    ...
                    <a style="display: flex;align-items: center;justify-content: flex-start;border-top: 2px solid lightgray;padding-top: 15px;" href="/openarena/index.php">
                        ...
                        <div class="instruction">Se connecter</div>
    ...
    <div id="lesmaps" style="width: 100;display: flex;justify-content: space-evenly;margin-top: 30px;flex-wrap: wrap;">
