<?php
    ...
    $touslesevenements=affichertouslesevenements();
...
<body>
    ...
    <?php foreach ($touslesevenements as $unevenement): ?>

    <div class="unevenement" style="height: 150px;width: 100%;border-radius: 5px;border: 1.5px solid lightgray;display: flex;justify-content: space-between;align-items: center;margin-bottom: 25px;">

        <img src="../../photodeprofils/uploads/<?= $unevenement->photo_evenement?>" style="width: 100px;height: 100px;margin-left: 10px;">

        <div class="infos" style="width: calc(100% - 150px);height: 100%;display: flex;flex-direction: column;justify-content: space-evenly;">
            <div style="font-size: 25px;color: gray;"><?= $unevenement->nom_evenement?></div>
            <div style="font-size: 16px;color: gray;">Crée le <?= $unevenement->date_creation?> par <?= $unevenement->pseudo_createur?></div>
            <div style="font-size: 16px;color: gray;">Nombre d'inscrits</div>
            <div style="font-size: 14px;padding-left: 150px;color: green;font-weight: bold;font-style: italic;">Cette partie débutera dans 5min</div>
            <div style="display: flex;justify-content: flex-end;">
                <button style="background-color: green;border: none;color: white;border-radius: 5px;height: 28px;margin-right: 25px;">Mode de jeu</button>
            </div>
