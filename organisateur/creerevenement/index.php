...
<body>
    ...
    <form style="" method="POST" action="indextraitement.php">
        ...
        <input type="text" name="nomevenement" placeholder="Nom de l'évènement" style="height: 33px;border: 1.5px solid lightgray;border-radius: 5px;font-size: 20px;text-align: center;margin-top: 50px;width: 70%;display: block;margin-bottom: 50px;margin-left: auto;margin-right: auto;">

        <div style="display: flex;justify-content: flex-start;margin-bottom: 10px;">
            <button style="background-color: green;border: none;color: white;border-radius: 5px;height: 32px;margin-right: 25px;">Mode de jeux</button>
        </div>

        <select id="modedejeux" name="modedejeux" class="form-control" style="height: 36px;background-color: white;margin-bottom: 50px;">
            <option value="OpenArena">OpenArena</option>
            <option value="missionpack">missionpack</option>
            <option value="OpenArena Community Mappack - Single Player Edi">OpenArena Community Mappack - Single Player Edi</option>
        </select>

        <div style="display: flex;justify-content: flex-start;margin-bottom: 10px;">
            <button style="background-color: green;border: none;color: white;border-radius: 5px;height: 32px;margin-right: 25px;">Date de l'évènement</button>
        </div>

        <input type="date" name="datedebut" style="height: 36px;background-color: white;margin-bottom: 50px;">

        <div style="display: flex;margin-bottom: 50px;width: 30%;position: relative;margin-left: auto;margin-right: auto;">
            <button type="submit" style="background-color: green;border: none;color: white;border-radius: 3px;height: 38px;margin-right: 25px;font-size: 20px;width: 100%;">Suivant</button>

            <svg style="position: absolute;right: 35px;" xmlns="http://www.w3.org/2000/svg" height="35" fill="white" width="35" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg>
        </div>
    </form>
