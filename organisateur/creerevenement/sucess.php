...
<body>
    ...
    <div id="couverture" style="height: 200px;width: 100%;background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBHMZbFnwwe0ctWR78xUvGLHO-nWnVvuIsFm8_gmSOnrhq_lCFhXRtmEzTLN8XF65vNBY&usqp=CAU');">
        
    </div>

    <img src="" style="width: 250px;height: 250px;border-radius: 5px;position: absolute;top: 200px;background-color: white;left: 50%;transform: translateX(-50%);">
