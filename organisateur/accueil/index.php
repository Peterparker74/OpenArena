...
<body>
    ...
    <div style="display: none;justify-content: center;margin-bottom: 50px;position: absolute;bottom: 100px;width: 100%;">
            <a href="../gestionnairetaches/index.php"><button type="submit" style="background-color: green;border: none;color: white;border-radius: 3px;margin-right: 25px;font-size: 16px;padding: 2px 5px 2 px 5px;">Aller au gestionnaire<br> des taches</button></a>
